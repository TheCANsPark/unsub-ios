...
class ComplaintDetailViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if complaintDetail == nil {
            return 0
        } else {
            if tableView.tag == 999 {
                return complaintDetail.assignedstkHolders!.count
            }else {
                return 1
            }
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if complaintDetail.incident_type == 2 {
            let detail = complaintDetail!
            
            let cell = tableView.dequeueReusableCell(withIdentifier: "VoiceTypeCaseTableCell")
            ...
            if tableView.tag == 999 { // AssigneStkholder Table
                ...
                let stkHolder = self.complaintDetail.assignedstkHolders![indexPath.row]
                ...
                if indexPath.section == 0 {
                    ...
                    if self.complaintDetail.assignedstkHolders!.count == 0 {
    ...
    @IBAction func showImgVideo(_ sender: Any) {
        ...
        vc?.imgArr = self.complaintDetail.images!
    ...
    @IBAction func playRecording(_ sender: Any) {
        ...
        vc.isFromCaseDetail = true
        vc.voiceURL = complaintDetail.voice_file?.first ?? NSURL() as URL
